...
class FlutterTextUtilsExample extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(title: const Text("Flutter Text Utils Example")),
      ...
      children: [
        buildSection("Basic Utilities", [
          ...
          buildExample(
            ...
            "test@mail.com".isEmail().toString(),
          ),
          buildExample(
            '"Pass@123".isStrongPassword()',
            "Pass@123".isStrongPassword().toString(),
          ),
        ...
        buildSection("Text Analysis", [
          buildExample(
            ...
            "Hello world".wordCount.toString(),
          ),
          buildExample(
            '"Hello world".charCount()',
            "Hello world".charCount().toString(),
          ),
          buildExample(
            '"Hello world".charCount(excludeSpaces: true)',
            "Hello world".charCount(excludeSpaces: true).toString(),
          ),
          buildExample(
            '"Hello world! How are you?".sentenceCount',
            "Hello world! How are you?".sentenceCount.toString(),
          ),
        ]),
